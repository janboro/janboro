<img src="https://github.com/janboro/janboro/blob/main/header.png?raw=true" align="center" style="width: 100%" />
...
- [A Selection of Optimization Algorithms](https://github.com/janboro/optimization_algorithms), Included algorithms:
...
- [A Blockchain Contract Interactor]() using Web3
- [Blockchain Multicall]() for gathering Chainlink contract data

#### Bachelor and Master Thesis

- [Unrelated Paralel Task Scheduling Problem](https://github.com/janboro/unrelated_paralel_task_scheduling) is my Masters thesis application for the subject.
- [Job Shop Problem](https://github.com/janboro/task_scheduling_problem), this was a warmup project for the [Unrelated Task TSP](https://github.com/janboro/unrelated_paralel_task_scheduling)
- [Travelly](https://github.com/janboro/travelly) a Bachelor solution to the Traveling Salesman Problem (TSP). This was my first bigger project done from beginning to end, thus the code quality leaves much to be desired.
...
- [Custom  Technical Indicators]() that are up to a 1000x faster then the [PandasTA](https://github.com/twopirllc/pandas-ta) implementation

#### Cybersecurity & Hacking

- [JSON Encrypter](https://github.com/janboro/presets_encrypter)
- [Bruteforce Password Cracker](https://github.com/janboro/password_cracker/blob/master/password_cracker.py)


#### Miscellaneous

- [Custom Python Decorators](https://github.com/janboro/python_decorators)
- [Python Logger](https://github.com/janboro/python_logger)
